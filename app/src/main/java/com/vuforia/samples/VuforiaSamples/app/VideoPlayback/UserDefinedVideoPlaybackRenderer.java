...
import com.vuforia.samples.VuforiaSamples.app.VideoPlayback.VideoPlayerHelper.MEDIA_TYPE;

public class UserDefinedVideoPlaybackRenderer  implements GLSurfaceView.Renderer{
...
private static final String LOGTAG = "VideoPlaybackRenderer";
    ...
    int videoPlaybackTextureID[] = new int[com.vuforia.samples.VuforiaSamples.app.VideoPlayback.VideoPlayback.NUM_TARGETS];
    ...
    UserDefinedVideoPlayback mActivity;
	...
	public UserDefinedVideoPlaybackRenderer(
			UserDefinedVideoPlayback activity,
 ...
 // Called to draw the current frame.
    ...
    void renderFrame()
    {
        ...
        RendererHelper.drawVideoBackground();
        ...
        for (int tIdx = 0; tIdx < state.getNumTrackableResults(); tIdx++)
        {
            ...
            if (imageTarget.getName().compareTo("stones") == 0)
                currentTarget = VideoPlayback.keyboard;
            else
                currentTarget = VideoPlayback.keyboard;
        ...
        float[] textureCoordMatrix)
    {
        ...
        if (target == VideoPlayback.keyboard)
        {
    ...
    void initRendering()
    {
        ...
        keyframeQuadAspectRatio[VideoPlayback.keyboard] = (float) mTextures
